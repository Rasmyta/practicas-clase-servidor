...
class IncidenciaDB {
    ...
    public static function insertInc($latitud,$longitud,$ciudad,$direccion,$etiqueta,$descripcion,$id_cliente) {
        ...
        $consulta = "INSERT INTO libros (latitud,longitud,ciudad,direccion,etiqueta,descripcion,estado,id_cliente) VALUES (:latitud, :longitud, :ciudad, :direccion, :etiqueta, :descripcion, 'abierta', :id_cliente)";
