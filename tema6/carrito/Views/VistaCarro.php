    ...
    public static function render($carro) {
        ...
        foreach ($carro->getLineasCarro() as $linea) {
            ...
            echo "<tr>
                    ...
                    <td><a href='controller.php?accion=mas&id=" . $producto->getId() . "'><i class='fas fa-plus-square px-2'></i></a>" . $linea->getCantidad();
            if ($linea->getCantidad() > 1) {
                echo "  <a href='controller.php?accion=menos&id=" . $producto->getId() . "'><i class='fas fa-minus-square px-2'></i></a></td>";
            }
            echo "  <td>" . $linea->getSubTotal() . " &euro;</td>
                    <td><a href='controller.php?accion=delete&id=" . $producto->getId() . "'><i class='fas fa-times'></i></a></td>
                </tr>";
        }
        ...
        echo "<div class='text-center m-5'>
                <a href='../index.php' class='btn btn-info m-3'><- Seguir comprando</a>
            </div>";
    }
}
